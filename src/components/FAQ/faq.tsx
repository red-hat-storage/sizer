    ...
    <Accordion asDefinitionList>
      <AccordionItem>
        <AccordionToggle
          ...
          id="1"
        >
          Bare metal and VM sizes only go up to 128GB RAM and 48 CPU Units, but
          I have more! Why can't I chose more?
        </AccordionToggle>
        <AccordionContent id="1-expanded" isHidden={visibleItem !== "1"}>
          We said that the maximum amount should be 20 OSDs per instance - that
          would correspond to ~40 CPU Units and ~100GB RAM (for a OSD-only node)
          - this is the reason why 128GB RAM is the highest choice. If the node
          is larger, there would be no change in the solver calculation.
        </AccordionContent>
      </AccordionItem>
      <AccordionItem>
        <AccordionToggle
          ...
          id="2"
        >
          I see that NooBaa Pods and MGR Pods are allocated twice in the solver,
          but they only get deployed once in my cluster - why is that?
        </AccordionToggle>
        <AccordionContent id="2-expanded" isHidden={visibleItem !== "2"}>
          ...
          everything that is not fault-tolerant by itself (like the RGW or MONs)
          even though that will not be consumed immediately. We do that to
          ensure the cluster is properly sized.
        </AccordionContent>
      </AccordionItem>
      <AccordionItem>
        <AccordionToggle
      ...
      <AccordionItem>
        ...
        <AccordionContent id="4-expanded" isHidden={visibleItem !== "4"}>
          This was a deliberate decision. Especially for bare metal deployments,
          customers would want to fill up nodes, before they add new ones. If
          not all nodes are full, they would want to have homogenous deployments
          and one "spillover" node, which they could easily fill up later on
          (instead of going to every single server and adding a disk)
        </AccordionContent>
      </AccordionItem>
      <AccordionItem>
        <AccordionToggle
